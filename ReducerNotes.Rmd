...
$$ \frac{\alpha'\beta + 1}{2\alpha'\beta}\left(\frac{(\alpha + \beta)'\gamma}{\sqrt{2 + 2\alpha'\beta}}\right)^2 - \frac{\alpha'\beta - 1}{2\alpha'\beta}\left(\frac{(\alpha - \beta)'\gamma}{\sqrt{2 - 2\alpha'\beta}}\right)^2 = 1$$
